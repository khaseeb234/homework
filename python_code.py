'''
#1
user_number=int(input("Ввидите число"))
user_number_2=int(input("Ввидите число"))
...
'''
#2
salary=float(input("Зарплата за месяц"))
...
'''
#5
text_4=str("\t«Life is what happens")
text_5=str("\t    when")
text_6=str("\t\tyou're busy making other plans»")
text_7=str("\t\t\t\t\tJohn Lennon")
print(text_4)
print(text_5)
print(text_6)
print(text_7)
